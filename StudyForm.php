...
<body>
    <div id="page">
        ...
        <form enctype="multipart/form-data" action="scripts/processForm.php" method="post" id="school_form">
            <div id="school">
                School/Department:
                <input class="underlinedInput" name="department" id="department" type="text"
                    placeholder="Information and Technology" onkeyup="validate( '#department', '#departmentError', department_regex)" required>
            </div>
            ...
            <div id="blockOne" class="block">
                <span>
                    ...
                    <input type="text" class="underlinedInput" name="studentName" id="studentname"
                           placeholder="First Last" onkeyup="validate( '#studentname', '#studentNameError', name_regex)" required>
                </span>
                ...
                <span>
                    ...
                    <input type="text" class="underlinedInput" name="idNumber" id="studentID"
                        placeholder="123456789" onkeyup="validate( '#studentID', '#idError', /(^\d{6,9}$)/)" required>
                </span>
                ...
                <span>
                    ...
                    <input type="text" class="underlinedInput" name="phone" id="phonenumber"
                        placeholder="(123) 456-789" onkeyup="validate( '#phonenumber', '#phoneError', phone_regex)" required>
                </span>
            ...
            <div id="blockThree" class="block">
                ...
                <input type="email" class="underlinedInput" name="email" id="email"
                    placeholder="name@email.radford.edu" onkeyup='validate( "#email", "#emailError", email_regex)' required>
            ...
            <div id="blockFour" class="italicText block">
                An Independent Study may be taken on a Pass-Fail basis or for a letter grade. &nbsp;Students may not
                apply more than six hours of credit for Independent Study toward graduation requirements.
            </div>
            ...
            <div class="block" id="blockNine">
                ...
                Fall 20
                <input type="text" class="underlinedInput year semester" name="fallSem" maxlength="2"
                       onkeyup='validate( "#fall", "#yearError", /^[\d]{2}$/)' id="fall">

                Spring 20
                <input type="text" class="underlinedInput year semester" name="springSem" maxlength="2"
                       onkeyup='validate( "#spring", "#yearError", /^[\d]{2}$/)' id="spring">

                Wintermester 20
                <input type="text" class="underlinedInput year semester" name="winterSem" maxlength="2"
            ...
            <div class="block" id="blockTen">
                Summer 20
                <input type="text" class="underlinedInput summerYear semester" name="summerSem" maxlength="2"
                       onkeyup='validateToOther( "#summerInput", "#summerError", /^[\d]{2}$/, "#blockTen")' id="summerInput"> :
            ...
            <div class="block" id="blockEleven">
                ...
                <select name="passfail" class="underlinedInput" id="passfail" required>
            ...
            <div class="block" id="blockThirteen">
                ...
                <input type="hidden" id="studentSignature" name="studentSignature" required/>
    ...
    <!-- Supervising Professor -->
            <div class="block" id="block15">
                ...
                <input type="hidden" id="supervisorSignature" name="supervisorSignature" required/>

                <input type="text" class="underlinedInput" id="prNameIn" name="prNameIn" onkeyup='validate( "#prNameIn", "#prNameInError", name_regex)' required>
    ...
    <!-- Academic Adviser Area -->
            <div class="block" id="block16">
                ...
                <input type="hidden" id="advisorSignature" name="advisorSignature" required/>

                <input type="text" class="underlinedInput" id="adNameIn" name="adNameIn" onkeyup='validate( "#adNameIn", "#adNameInError", name_regex)' required>
    ...
    <!-- Department/School Curriculum Committee Chair Area -->
            <div class="block" id="block17">
                ...
                <div style="margin-top: 2.13%">
                    ...
                    <div id="depSigIn" class="underlinedInput signatureDiv"></div>
                    <input type="hidden" id="departmentSignature" name="departmentSignature" class="notrequiered"/>
    ...
    <!-- Chair/School Director Area -->
            ...
            <div class="block" id="block19">
                ...
                forms. &nbsp;Completed independent study proposal forms (including all signatures) must be submitted to
                the Registrar's Office prior to the deadline for adding courses in the term in which the study is to be
                undertaken. &nbsp;<b>Staff in the Registrar's Office will enroll the student in the Independent Study
                course; <i>i.e.</i>, the student need not take additional action to register for the course.</b>
            </div>
...
<script>
    ...
    $(function () {
        ...
        //Initialize the pads bades on the dimensions of the div they are contained in.
